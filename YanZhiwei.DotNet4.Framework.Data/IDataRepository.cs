namespace YanZhiwei.DotNet4.Framework.Data
{
    ...
    public interface IDataRepository
    {
        ...
        /// 时间：2016-01-13 13:32
        /// 备注：
        T Find<T, F>(params object[] keyValues)
        where T : ModelBase<F>;
        ...
        /// 时间：2016-01-13 13:32
        /// 备注：
        List<T> FindAll<T, F>(Expression<Func<T, bool>> conditions = null)
        where T : ModelBase<F>;
        ...
        /// 时间：2016-01-13 13:33
        /// 备注：
        PagedList<T> FindAllByPage<T, S, F>(Expression<Func<T, bool>> conditions, Expression<Func<T, S>> orderBy, int pageSize, int pageIndex)
        where T : ModelBase<F>;
