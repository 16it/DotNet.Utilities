...
namespace YanZhiwei.DotNet2.Utilities.Common.Tests
{
    ...
    public class SortHelperTests
    {
        ...
        public void BubbleSortTest()
        {
            ...
            Student _student3 = new Student()
            {
                Name = "Yan", Age = 26
            };
            Student _student4 = new Student()
            {
                Name = "Yan", Age = 14
            };
            ...
            Student _studentEx1 = new Student()
            {
                Name = "Yan", Age = 14
            };
            Student _studentEx2 = new Student()
            {
                Name = "Yan", Age = 19
            };
            Student _studentEx3 = new Student()
            {
                Name = "Yan", Age = 22
            };
            Student _studentEx4 = new Student()
            {
                Name = "Yan", Age = 26
            };
            Student _studentEx5 = new Student()
            {
                Name = "Yan", Age = 88
            };
            Student[] _studentExArray = new Student[5] { _studentEx1, _studentEx2, _studentEx3, _studentEx4, _studentEx5 };
            bool _expected = ModelHelper.CompletelyEqual<Student>(_studentArray, _studentExArray);
