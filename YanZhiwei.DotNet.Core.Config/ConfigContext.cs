namespace YanZhiwei.DotNet.Core.Config
{
    ...
    public class ConfigContext
    {
        ...
        public virtual T Get<T>(string index)
        ...
        /// <param name="index">分区索引</param>
        public void Save<T>(T configFile, string index)
        ...
        /// <typeparam name="T">泛型</typeparam>
        /// <param name="configFile">配置文件类型</param>
        public void Save<T>(T configFile)
        where T : ConfigFileBase
        {
        ...
        /// <param name="index">分区索引</param>
        private void CheckedClusteredByIndex<T>(T configFile, string index)
        where T : ConfigFileBase
        {
