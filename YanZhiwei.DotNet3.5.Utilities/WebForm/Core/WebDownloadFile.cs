namespace YanZhiwei.DotNet3._5.Utilities.WebForm.Core
{
    ...
    public class WebDownloadFile
    {
        ...
        {
            CheckResult _checkedFileDownloadParamter = CheckedFileDownloadParamter(fileName, filePhysicsPath);

            if(_checkedFileDownloadParamter.State)
            {
                return FileDownloadResult.Fail(fileName, filePhysicsPath, _checkedFileDownloadParamter.Message);
            }
