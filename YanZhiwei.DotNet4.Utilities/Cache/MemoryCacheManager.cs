...
namespace YanZhiwei.DotNet4.Utilities.Cache
{
    ...
    public class MemoryCacheManager
    {
        ...
        public static bool Contains(string key)
        {
            ...
            return objectCache.Contains(_cacheKey);
        }
        /// <summary>
        /// 以键取值
        /// </summary>
        ...
        public static void Set(string key, object value, int seconds, bool isAbsoluteExpiration, CacheEntryUpdateCallback updateCallback, CacheEntryRemovedCallback removedCallback)
        {
        ...
        /// <param name="seconds">秒</param>
        /// <param name="isAbsoluteExpiration">是否绝对时间</param>
        public static void Set(string key, object value, int seconds, bool isAbsoluteExpiration)
        {
            Set(key, value, seconds, isAbsoluteExpiration, null, null);
        }

        private static void CheckedParamter(string key, object value)
        {
            ValidateOperator.Begin().NotNullOrEmpty(key, "缓存键").NotNull(value, "缓存数据");
        }

        private static void CheckedParamter(string key)
        {
