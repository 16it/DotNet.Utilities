...
namespace PetaPoco
{
    ...
    public class Database : IDisposable
    {
        ...
        {
            return MultiPocoQuery<TRet>(new Type[] { typeof(T1), typeof(T2) }, cb, sql, args);
        }
        ...
        {
            return MultiPocoQuery<TRet>(new Type[] { typeof(T1), typeof(T2) }, cb, sql.SQL, sql.Arguments);
        }
        ...
        {
            return MultiPocoQuery<T1>(new Type[] { typeof(T1), typeof(T2) }, null, sql, args);
        }
        ...
        {
            return MultiPocoQuery<T1>(new Type[] { typeof(T1), typeof(T2) }, null, sql.SQL, sql.Arguments);
        }
        ...
        private Func<IDataReader, object, TRet> CreateMultiPocoFactory<TRet>(Type[] types, string sql, IDataReader r)
        {
            ...
            il.Emit(OpCodes.Ret);
            // Finish up
            return (Func<IDataReader, object, TRet>)m.CreateDelegate(typeof(Func<IDataReader, object, TRet>), new MultiPocoFactory()
            {
                m_Delegates = dels
            });
        }
